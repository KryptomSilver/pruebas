  ...
  return (
    <View style={{flex:1}}>
      <View style={{flexGrow:1, alignItems:'center', justifyContent:'center'}}>
        ...
        <Text style={styles.cuerpo}>Ingenería en Informática</Text>
        <Text style={styles.cuerpo}>16460094</Text>
        <Text style={styles.cuerpo}>Abel Romero Ruiz</Text>
        <Text style={styles.cuerpo}>MARZO-JUNIO 2021</Text>
      </View>
